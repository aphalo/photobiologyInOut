...
## Data from loggers and other instruments
...
[Heinz Walz Gmbh](https://www.walz.com/) supplies several instruments for the
measurement of photosyntheis. The instruments are based on two different
principles: measurement of gas-exchange, and measurement of chlorophyll
fluorescence. Currently, data logged using the LSA-2050 leaf state analyzer can
be imported into R with function `read_walz_lsa_xlsx()`.
