...
#' irradiance data file as output by the text conversion tool for ASD
#' spectrometers. ASD's field spectrometers measure VIS and SWIR radiation.
#' The spectral irradiance text files seem to be tab plus space delimited.
#' 
...
read_asdtxt_irrad <- function(file,
  ...
  # if (!(grepl("\\.asd", line02[1]) && grepl("^from", line01[2]))) {
