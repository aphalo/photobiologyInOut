...
Data files from **spectrometers** from the following suppliers are currently supported: Avantes, LI-COR, Macam Photonics, and Ocean Optics. 
...
**PLEASE, BE VERY CAREFUL WHEN USING THIS PACKAGE. DO CHECK THAT UNITS USED IN THE IMPORTED FILE ARE THOSE EXPECTED BY THESE FUNCTIONS AND THAT THE VALUES IN THE
RETRIEVED DATA ARE THOSE EXPECTED!**
...
Pull requests, bug reports, and feature requests are welcome at (https://bitbucket.org/aphalo/photobiologyInOut). Contribution of example data files that could
